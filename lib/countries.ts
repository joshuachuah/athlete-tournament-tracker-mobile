...
const countryByCode = new Map<string, (typeof countries)[number]>(
...
export function getCountryByName(name: string | null | undefined) {
  return name ? countryByName.get(name.trim().toLowerCase()) ?? null : null;
}

export function estimatedWithholdingAfterCountryChange(
  previousCode: CountryCode | null,
