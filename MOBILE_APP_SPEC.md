...
3. Google sign-in requests a Supabase OAuth URL and opens it with
   ...
   `https://web-production-2fa073.up.railway.app/auth/callback` in signed
   production builds on iOS 17.4+ and `athletetracker://auth/callback` in
   development builds, Android, and older supported iOS versions.
